...
const APP_ICONS={
  ...
  exercises:{exercise:"assets/illustrations/exercises/exercise.png",target:"assets/illustrations/exercises/target.png",success:"assets/illustrations/exercises/success.png"},
...
function streakData(){try{return JSON.parse(localStorage.getItem("bolajonStreak")||'{"count":0,"last":"","days":[]}')}catch(e){return{count:0,last:"",days:[]}}}
...
function markActivity(){
  const d=new Date(), today=localDay(d), z=streakData();
...
function open(c){if(!L[c])return;cat=c;lessonIndex=0;markActivity();$("#menu").hidden=true;$("#lesson").hidden=false;renderLesson();view("lessons")}
